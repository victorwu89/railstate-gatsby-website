    ...
    return (
      <html {...this.props.htmlAttributes}>
        <head>
          ...
          <link rel="icon" type="image/png" sizes="16x16" href="/icons/RailStateFavicon-16px.ico" />
          <link rel="icon" type="image/png" sizes="32x32" href="/icons/RailStateFavicon-32px.ico" />
          <link rel="icon" type="image/png" sizes="96x96" href="/icons/favicon-96x96.png" />
          <link
            href="https://fonts.googleapis.com/css?family=Montserrat:400,700&display=swap"
            rel="stylesheet"
          />
          <script src="https://www.google.com/recaptcha/api.js?render=6LeiuN0UAAAAABT43ve4iwmMuiGqcKRBbjaNy7j-" />
        </head>
